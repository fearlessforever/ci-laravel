...
(function( $ ){
	$.fn.easyTable = function (options) {
	   ...
	   this.paging =function(){
		  ...
		  limit = ( parseInt( this.options.page.total ) % parseInt( this.options.page.limit ) ) > 0 ? parseInt(limit)+1 : parseInt(limit)  ;
		  
		  table.append('<ul class="pagination pull-right"><li class="disabled"><a href="#" data-info="prev"> Previous </a></li><li class="active"><a href="#" data-info="cnt">1</a></li><li class="'+(limit <= 0?'disabled':'')+'"><a href="#" data-info="next">Next </a></li></ul>');
