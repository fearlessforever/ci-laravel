...
*/function setUpUrl(e){
	...
	$(document).ready(function(e){
	   ...
	   loadCSS(helmi.asset +"plugins/gritter/css/jquery.gritter.css" );loadCSS(helmi.asset +"plugins/gritter/css/aku-gritter.css" );
