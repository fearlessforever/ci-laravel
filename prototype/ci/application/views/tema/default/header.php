<head>
	    ...
	    <title><?php echo isset($title['isi1']) ? $title['isi1'] : 'No Title'; ?></title>
		...
		helmi.home="<?php echo $home; ?>",helmi.asset="<?php echo $asset; ?>",helmi.current="<?php echo $__current; ?>",helmi.controller='';
