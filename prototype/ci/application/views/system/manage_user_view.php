...
loadCSS("<?php echo $asset ?>plugins/a/bootstrap-ext/bootstrap-select/bootstrap-select.css");
loadCSS("<?php echo $asset ?>plugins/easytable/easyTable.css");
...
loadJS([
	...
	"<?php echo $asset ?>plugins/easytable/easyTable.js"
	,"<?php echo $asset ?>plugins/a/bootstrap-ext/bootstrap-select/bootstrap-select.js"
	,"<?php echo $asset ?>js/reset.js"
],'<?php echo $asset ?>js/manage-user.js','content-wrapper');
